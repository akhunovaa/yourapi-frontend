...
class ApiDetailDocumentationHeader extends Component {
    ...
    render() {
        return (
            <div className='header-links-list'>
                ...
                <div className='header-links-methods-documentation header-links-font active-header-container'>
                    <NavLink to='/shop/category/data/api?page=documentation' className='active-header-link'>Документация</NavLink>
                </div>
                <div className='header-links-methods header-links-font'>
...
export default ApiDetailDocumentationHeader;