...
class ApiUpdateAnnouncementsHeader extends Component {
    ...
    render() {
        ...
        return (
            <div className='update-header-links-list'>
                ...
                <div className='left-link-header-font update-header-links-methods update-header-links-font '>
                    <NavLink to={'/profile/api?page=update&name=' + this.props.naming + '&definition=docs'} className='update-active-header-link'>Документация</NavLink>
                </div>
...
export default ApiUpdateAnnouncementsHeader;