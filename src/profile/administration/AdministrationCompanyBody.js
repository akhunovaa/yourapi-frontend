...
class AdministrationCompanyBody extends Component {
    ...
    render() {
        ...
        const dealOptions = [
            {
                deal: 'Поставщики услуг',
                text: 'Поставщики услуг',
                value: 'Поставщики услуг'
            },
            {
                deal: 'Проституция',
                text: 'Проституция',
            ...
            {
                deal: 'Страхование киберрисков',
                text: 'Страхование киберрисков',
                value: 'Страхование киберрисков'
            }
        ];
        ...
        return (
              <div className='administration-body-main'>
                  ...
                  <div className="command-info-container">
                      ...
                      <div className="command-info-container-name-inputs">
                          <div className="command-info-container-name-input">
                              ...
                              <Input onChange={this.handleInputChange} defaultValue={this.state.company.name}
                          ...
                          <div className="command-info-container-name-input">
                              <label style={{paddingBottom: '6px'}}>Род деятельности</label>
                              <Dropdown onChange={this.handleDropdownChange} placeholder='Род деятельности' fluid search
                                        selection id="dealType" name="dealType" noResultsMessage="Москва - лучший город"
                                        className="form-input" options={dealOptions}
                                        defaultValue={this.state.dealType}/>
                          </div>
                      </div>
                  </div>
                  <div className="company-info-container">
                      <div className="company-info-container-name">
                          <span>Контакты</span>
                      </div>
                      <div className="command-info-container-name-input">
                  ...
                  <div className="company-info-container">
                      ...
                      <div className="company-info-container-name-input">
                          <div className="command-info-container-name-textarea">
                              <Form style={{paddingTop: '6px'}}>
                                  <TextArea onChange={this.handleDropdownChange} placeholder='' style={{minHeight: 265, maxHeight: 265, minWidth: 382 }}  id="registrationData" name="registrationData" defaultValue={this.state.registrationData}/>
                              </Form>
                          </div>
                      </div>
                  </div>
...
export default withRouter(AdministrationCompanyBody);