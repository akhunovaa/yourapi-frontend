                ...
                <div className='help-sub-page-right'>
                    <div className='help-sub-page-right-body'>
                        ...
                        <div className='help-sub-page-right-body-header-text'>
                            ...
                            существующего API.
                            Для вашего удобства по ссылке развернули приложение с графическим интерфейсом, где каждый
                        ...
                        <div className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            2. Во вкладке Servers добавим внешний API сервер <a href='https://cat-fact.herokuapp.com/'
                        ...
                        <div className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            ...
                            Формат файла может быть любым и выбор зависит от вашего предпочтения в данным форматам. Я же
                            выбираю JSON.
                        </div>
                        <div className='help-sub-page-right-body-header-image'>
                        ...
                        <div className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            5. Сохраняем файл у себя на жестком диске. Должен получится файл примерно такого же формата
                        ...
                        <div id='upload' className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            6. Этапы по созданию файла пройдены и все готово для создания API на нашем Marketplace, где
                            он будет доступен для всех желающих. В личном кабинете профиля, необходимо перейти в Мои API
                        ...
                        <div className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            7. OpenAPI файл, который был сгенерирован выше, загружаем сюда путем перетаскивания файла на
                            специально выделенную область серого цвета или же можно выбрать с компьютера нажав на ссылку
                            Загрузить. Далее нажимаем кнопку Добавить. После удачной загрузки файла, переходим на
                            страницу редактирования загруженного API. При желании, на данной странице можно загрузить
                            изображение.
                        </div>
                        <div className='help-sub-page-right-body-header-image'>
                        ...
                        <div className='help-sub-page-right-body-header-text help-sub-page-right-body-header-next-text'>
                            9. Ваш проект создан и теперь он доступен для пользователей. Можно поделиться с кем либо ссылкой <a href='https://101-Interesnie-fakt.p.yourapi.ru' target='_blank'>101-Interesnie-fakt.p.yourapi.ru</a>
                        </div>
